...
Route::get('/boards/players_actions/{id}/board_id/{board_id}/task/{task}',[App\Http\Controllers\PlayersActionsController::class, 'index'])->name('action')->middleware("auth");
Route::get('/boards/players_actions/edit/{id}',[App\Http\Controllers\PlayersActionsController::class,'edit'])->name("editAction")->middleware("auth");
...
Route::get('/boards/currentBoard/sendBank/{id}',[App\Http\Controllers\PlayersController::class, 'sendBank'])->name('sendBank')->middleware("auth");
Route::get('/boards/currentBoard/sendToEveryone/{id}',[App\Http\Controllers\PlayersController::class, 'sendToEveryone'])->name('sendToEveryone')->middleware("auth");
Route::get('/boards/currentBoard/sendToEveryoneStore/{id}',[App\Http\Controllers\PlayersController::class, 'sendToEveryoneStore'])->name('sendToEveryoneStore')->middleware("auth");
Route::get('/boards/currentBoard/sendBankStore/{id}',[App\Http\Controllers\PlayersController::class, 'sendBankStore'])->name('sendBankStore')->middleware("auth");
Route::get('/boards/currentBoard/sendToAnotherPlayer/{id}',[App\Http\Controllers\PlayersController::class, 'sendToAnotherPlayer'])->name('sendToAnotherPlayer')->middleware("auth");
Route::get('/boards/currentBoard/sendToAnotherPlayerStore/{id}',[App\Http\Controllers\PlayersController::class, 'sendToAnotherPlayerStore'])->name('sendToAnotherPlayerStore')->middleware("auth");
